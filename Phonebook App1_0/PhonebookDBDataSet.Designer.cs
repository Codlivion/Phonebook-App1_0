...
namespace Phonebook_App1_0 {
    ...
    public partial class PhonebookDBDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PersonRow AddPersonRow(string first_name, string last_name, string info, string phone_number, string e_mail) {
        ...
        public partial class PersonRow : global::System.Data.DataRow {
            ...
            public string info {
                get {
                    try {
                        return ((string)(this[this.tablePerson.infoColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'info\' in table \'Person\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePerson.infoColumn] = value;
                }
            }
            ...
            public string e_mail {
                get {
                    try {
                        return ((string)(this[this.tablePerson.e_mailColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'e_mail\' in table \'Person\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePerson.e_mailColumn] = value;
                }
            }
            ...
            public bool IsinfoNull() {
                return this.IsNull(this.tablePerson.infoColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetinfoNull() {
                this[this.tablePerson.infoColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public bool Ise_mailNull() {
                return this.IsNull(this.tablePerson.e_mailColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void Sete_mailNull() {
                this[this.tablePerson.e_mailColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Phonebook_App1_0.PhonebookDBDataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Person] WHERE (([person_ID] = @Original_person_ID) AND ([first_name] = @Original_first_name) AND ((@IsNull_last_name = 1 AND [last_name] IS NULL) OR ([last_name] = @Original_last_name)) AND ((@IsNull_info = 1 AND [info] IS NULL) OR ([info] = @Original_info)) AND ([phone_number] = @Original_phone_number) AND ((@IsNull_e_mail = 1 AND [e_mail] IS NULL) OR ([e_mail] = @Original_e_mail)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Person] ([first_name], [last_name], [info], [phone_number], [e_mail]) VALUES (@first_name, @last_name, @info, @phone_number, @e_mail);
SELECT person_ID, first_name, last_name, info, phone_number, e_mail FROM Person WHERE (person_ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Person] SET [first_name] = @first_name, [last_name] = @last_name, [info] = @info, [phone_number] = @phone_number, [e_mail] = @e_mail WHERE (([person_ID] = @Original_person_ID) AND ([first_name] = @Original_first_name) AND ((@IsNull_last_name = 1 AND [last_name] IS NULL) OR ([last_name] = @Original_last_name)) AND ((@IsNull_info = 1 AND [info] IS NULL) OR ([info] = @Original_info)) AND ([phone_number] = @Original_phone_number) AND ((@IsNull_e_mail = 1 AND [e_mail] IS NULL) OR ([e_mail] = @Original_e_mail)));
SELECT person_ID, first_name, last_name, info, phone_number, e_mail FROM Person WHERE (person_ID = @person_ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Phonebook_App1_0.Properties.Settings.Default.PhonebookDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT person_ID, first_name, last_name, info, phone_number, e_mail FROM dbo.Pers" +
                "on";
        ...
        public virtual int Delete(int Original_person_ID, string Original_first_name, string Original_last_name, string Original_info, string Original_phone_number, string Original_e_mail) {
        ...
        public virtual int Insert(string first_name, string last_name, string info, string phone_number, string e_mail) {
            if ((first_name == null)) {
        ...
        public virtual int Update(string first_name, string last_name, string info, string phone_number, string e_mail, int Original_person_ID, string Original_first_name, string Original_last_name, string Original_info, string Original_phone_number, string Original_e_mail, int person_ID) {
            if ((first_name == null)) {
                throw new global::System.ArgumentNullException("first_name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string first_name, string last_name, string info, string phone_number, string e_mail, int Original_person_ID, string Original_first_name, string Original_last_name, string Original_info, string Original_phone_number, string Original_e_mail) {
            return this.Update(first_name, last_name, info, phone_number, e_mail, Original_person_ID, Original_first_name, Original_last_name, Original_info, Original_phone_number, Original_e_mail, Original_person_ID);
        }
    }
